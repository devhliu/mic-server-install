...
# Configure Ubuntu mirrors using PKU mirror as specified in mirrors.yaml
...
# For Ubuntu 24.04 and later, the main configuration might be in /etc/apt/sources.list.d/ubuntu.sources
# We remove it to ensure our sources.list is used.
