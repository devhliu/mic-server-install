...
### step00_install_ubuntu.sh - System Optimization
...
### step01_install_python.sh - Python & Conda
...
### step02_install_node.sh - Node.js Environment
...
### step05_install_vibecoding_skills.sh - Skills Installation
Installs additional skills and utilities for AI-assisted development.
- **Tools**:
  - `just-bash`: Just Bash utilities.
  - Various skills from GitHub repositories for opencode and trae-cn agents.

### step06_install_huggingface-models.sh - Hugging Face Model Downloader
Downloads models or specific files from Hugging Face Hub with China mirror support.
- **Features**:
  - Support for full model repository download.
  - Support for specific file download.
  - China mirror (hf-mirror.com) enabled by default.
  - Configurable output directory and revision.
...
# Step 5: Install AI coding skills
./step05_install_vibecoding_skills.sh

# Step 6: Download Hugging Face models (optional)
./step06_install_huggingface-models.sh -t hf_xxx -m bert-base-uncased
```
...
For a full list of configured mirrors and registry settings, refer to [mirrors.yaml](file:///mirrors.yaml).
